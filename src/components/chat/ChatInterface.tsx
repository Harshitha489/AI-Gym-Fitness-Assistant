...
export const ChatInterface = () => {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: "Hey there! 💪 I'm FitBuddy, your AI fitness companion. I'm here to help you with workouts, nutrition, motivation, and all things fitness. What can I help you with today?",
    },
  ]);
